...
class MinkFPN(ResNetBase):
    ...
    def network_initialization(self, in_channels, out_channels, D):
        ...
        # extra_block_dim = self.lateral_dim

        # self.tconv4_2 = ME.MinkowskiConvolutionTranspose(128,64,kernel_size=2,stride=2, dimension=D)

        # self.tconv2_1 = ME.MinkowskiConvolutionTranspose(64,32,kernel_size=2,stride=2, dimension=D)


        # self.tconv2_1 = ME.MinkowskiMaxPooling()
